...
namespace WebApplication1
{
    public partial class cookiecollection : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Cookies["Computer"]["CheckBox1"] = "You have Checked for Iphone And Cookie Triggered ";
               
            }
            if(CheckBox2.Checked)
            {
                Response.Cookies["Computer"]["CheckBox2"] = "You have Checked for OnePlus And Cookie Triggered";

            }
            if(CheckBox3.Checked)
            {
                Response.Cookies["Computer"]["CheckBox3"] = "You have Checked for Samsung And Cookie Triggered";

            }
            if(CheckBox4.Checked)
            {
                Response.Cookies["Computer"]["CheckBox4"] = "You have Checked for Nokia And Cookie Triggered";

            }
            if(CheckBox5.Checked)
            {
                Response.Cookies["Computer"]["CheckBox5"] = "You have Checked for MI And Cookie Triggered";
            }
            if (CheckBox6.Checked)
            {
                Response.Cookies["Computer"]["CheckBox6"] = "You have Checked for Oppo And Cookie Triggered";
            }
            if (CheckBox7.Checked)
            {
                Response.Cookies["Computer"]["CheckBox7"] = "You have Checked for Vivo And Cookie Triggered";
            }
            if (CheckBox8.Checked)
            {
                Response.Cookies["Computer"]["CheckBox8"] = "You have Checked for Motrolla And Cookie Triggered" ;
            }
            if (CheckBox9.Checked)
            {
                Response.Cookies["Computer"]["CheckBox9"] = "You have Checked for Realme And Cookie Triggered" ;
            }
            if (CheckBox10.Checked)
            {
                Response.Cookies["Computer"]["CheckBox10"] = "You have Checked for Poco M2 And Cookie Triggered";
            }
